...
//  	<--inizio della creazione della struttura del contenuto specifico della pagina
 	$cooling_system = $body->ownerDocument->createElement ("section");
 	$cooling_system->setAttribute ("id", "impianti-di-climatizzazione");
 	$cooling_system->setAttribute ("class", "section_content");
 	
 	$container = $cooling_system->ownerDocument->createElement ("div");
...
//  	aggiungo il contenuto
	...
	$main_feature->appendChild ($col);
 	...
 	$cooling_system->appendChild ($container);
 	$body->appendChild($cooling_system);
